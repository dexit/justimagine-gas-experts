...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    howTo: [
      { step: 1, title: "Phone or book online", desc: "Call 07774 079152 or use our online form to describe the fault and get a callback within the hour." },
      { step: 2, title: "We schedule a visit", desc: "We aim for same-day if you call before noon. We'll confirm time and take a brief description of symptoms." },
      { step: 3, title: "Engineer diagnoses", desc: "On arrival, the engineer checks fault codes, tests components, and identifies the exact cause — no guesswork." },
      { step: 4, title: "Fixed price quote", desc: "Before touching anything, we explain what's wrong, show our findings, and quote a fixed repair price in writing." },
      { step: 5, title: "You approve and we fix", desc: "You decide whether to proceed. Once approved, we order parts (usually in stock) and complete the repair same day." },
      { step: 6, title: "12-month guarantee", desc: "All repairs carry a 12-month parts and labour guarantee. We'll be back free if the same fault recurs." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
    ...
    howTo: [
      { step: 1, title: "Book your annual service", desc: "Annual services should be done in early autumn before winter demand peaks. Call us or use our online booking form." },
      { step: 2, title: "We visit your home", desc: "Our engineer arrives on time, fully equipped with testing gear, replacement filters, and cleaning tools." },
      { step: 3, title: "Complete visual inspection", desc: "We check the casing, flue terminal, pipework, and condensate drain for any visible damage or deterioration." },
      { step: 4, title: "Clean and test internals", desc: "We clean the burner and heat exchanger if needed, test gas pressures, run a combustion analysis, and perform a CO safety check." },
      { step: 5, title: "Issue service report", desc: "You receive a detailed written report with all test readings, any recommendations, and confirmation the boiler is safe and efficient." },
      { step: 6, title: "Automatic annual reminder", desc: "We send a free reminder 12 months later so you never forget and your warranty stays valid." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
    ...
    howTo: [
      { step: 1, title: "Schedule your CP12 inspection", desc: "Annual gas safety inspections are a legal requirement. Give 24 hours' notice to tenants to coordinate access." },
      { step: 2, title: "Engineer inspects all gas appliances", desc: "We test the boiler, hob, gas fire, cooker, and any other gas fittings. Flue flow, combustion, and gas pressures are all tested and recorded." },
      { step: 3, title: "We classify any faults", desc: "If an appliance is safe, it passes. If it has minor faults, we classify it as At Risk. If it's immediately dangerous, we disconnect it and report to HSE." },
      { step: 4, title: "Digital CP12 issued same day", desc: "You receive the certificate by email within hours of completion. Copies are automatically sent to your tenant and letting agent." },
      { step: 5, title: "Store your records safely", desc: "We keep digital copies and send reminders before expiry — your certificate never lapses and you stay compliant." },
      { step: 6, title: "Arrange any remedial work", desc: "If an appliance is unsafe, we provide a quotation for repair or replacement. You decide and we handle the work directly." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
  ...
  },
  {
    ...
    howTo: [
      { step: 1, title: "Book a heating survey", desc: "We visit your home, inspect your current system (or lack of one), and discuss your heating needs, room size, and budget." },
      { step: 2, title: "Get a fixed written quote", desc: "We design a system tailored to your property and provide a detailed quote breaking down all costs — no hidden charges." },
      { step: 3, title: "We plan the installation", desc: "We coordinate the work schedule, arrange any access needs, and explain what to expect during installation (usually 2–5 days depending on scope)." },
      { step: 4, title: "Install pipes, radiators, boiler & controls", desc: "Our team install all pipework, fit radiators in each room, commission the boiler, and program your controls and thermostat." },
      { step: 5, title: "System pressure test & commission", desc: "We pressure-test the entire system, balance radiators for even heat distribution, and test all controls and safety devices." },
      { step: 6, title: "Handover and training", desc: "We walk you through how to use your new system, provide a 10-year warranty, and annual service reminders to keep it efficient." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
    ...
    howTo: [
      { step: 1, title: "Drip or burst? Isolate the water", desc: "Find your main stopcock (usually under the kitchen sink) and turn it off. For burst pipes, open affected taps to drain remaining water." },
      { step: 2, title: "Call us for same-day response", desc: "We respond to emergency plumbing calls the same day. Tell us what you need — leak, burst, no hot water, blocked toilet." },
      { step: 3, title: "We diagnose the problem", desc: "On arrival, we locate the fault, explain what's wrong, and quote a fixed price before proceeding." },
      { step: 4, title: "We repair or replace", desc: "Whether it's a simple washer, a new tap, a burst pipe section, or a cylinder replacement, we complete the work in one visit." },
      { step: 5, title: "Test and clean", desc: "We test all fixtures, pressure-test repaired sections, and ensure everything works correctly before we leave." },
      { step: 6, title: "Full 12-month guarantee", desc: "All plumbing work carries a 12-month guarantee. If the same fault recurs, we're back for free." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
    ...
    howTo: [
      { step: 1, title: "Identify sludge symptoms", desc: "Cold radiators that don't heat despite bleeding, boiler running constantly, or cold spots in radiators are signs of magnetite sludge buildup." },
      { step: 2, title: "Book a system inspection", desc: "We visit and drain a sample from the lowest radiator to check for black sludge. If present, we recommend a power flush." },
      { step: 3, title: "We prepare your system", desc: "We install isolation valves, fit a magnetic filter, and prepare all radiators for high-velocity flushing." },
      { step: 4, title: "High-velocity power flush", desc: "Using professional-grade equipment, we circulate chemical cleaning agents through the entire system at high velocity to dislodge and remove all sludge." },
      { step: 5, title: "Radiator-by-radiator confirmation", desc: "We test each radiator individually and continue flushing until every radiator runs clear — no rushed jobs." },
      { step: 6, title: "New inhibitor added + magnetic filter installed", desc: "Once clean, we refill with fresh treated water, add inhibitor to prevent future corrosion, and leave the magnetic filter in place for ongoing protection." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
    ...
    howTo: [
      { step: 1, title: "Recognise the emergency", desc: "No heat or hot water, gas smell, boiler flooding, uncontrolled leak, or CO alarm — these need immediate action." },
      { step: 2, title: "Call 07774 079152 — we answer 24/7", desc: "Phone us immediately. We take your details: address, what's wrong, any immediate dangers (gas, water)." },
      { step: 3, title: "We prioritise and dispatch", desc: "We assess the situation on the phone, advise immediate steps (isolation, safety), and dispatch an engineer aiming for 60–90min response." },
      { step: 4, title: "Engineer diagnoses", desc: "On arrival, they diagnose the fault, explain what's wrong, and quote a fixed repair price including out-of-hours rates." },
      { step: 5, title: "You approve and we fix", desc: "Once approved, we complete the repair using genuine parts and test everything to confirm it's safe and working." },
      { step: 6, title: "Out-of-hours fee agreed upfront", desc: "All emergency costs — call-out fee, parts, labour, out-of-hours rates — are confirmed before we start work." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
    ...
    howTo: [
      { step: 1, title: "Assess your property", desc: "We visit, measure your room, review your existing heating, and calculate heat loss to size the UFH system correctly." },
      { step: 2, title: "Design the system", desc: "We create a pipe layout, calculate manifold sizing, and plan installation around your floor type (screeded, overlay, or suspended timber)." },
      { step: 3, title: "Prepare the floor", desc: "We lay insulation, then pipe loops at the correct spacing. For screeded floors, we oversee the screed pour to protect pipework." },
      { step: 4, title: "Install the manifold", desc: "The manifold collects all zones and integrates with your boiler or heat pump. We fit a blending valve if needed to regulate temperature." },
      { step: 5, title: "Pressure test and commission", desc: "We fill the system, pressure-test every joint, balance all zones for even heat distribution, and test controls." },
      { step: 6, title: "Handover and training", desc: "You receive full commissioning docs, warranties, and training on how to use zone controls and optimize your heating." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
    ...
    howTo: [
      { step: 1, title: "Book a home survey", desc: "We visit, measure your heating system, calculate heat loss, and discuss whether an air-source heat pump is right for your property." },
      { step: 2, title: "Get a fixed written quote", desc: "Based on the survey, we quote the full installed cost. We explain grant eligibility and the net cost after the £7,500 BUS scheme." },
      { step: 3, title: "Apply for the BUS grant", desc: "We handle the entire Boiler Upgrade Scheme application. You just provide an EPC and approve the quote. No paperwork stress." },
      { step: 4, title: "Install outdoor and indoor units", desc: "We position the outdoor unit (with noise and planning compliance checked), install the indoor components, and connect to your heating system." },
      { step: 5, title: "Commission and system test", desc: "We pressure-test all circuits, fill the system, commission all controls, and perform full performance testing to confirm everything works as specified." },
      { step: 6, title: "Handover with training", desc: "You receive full documentation, maintenance schedules, and training on smart controls and how to maximize efficiency and lower bills." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {
  ...
  },
  {
    ...
    howTo: [
      { step: 1, title: "Assess your radiators", desc: "Slow to heat, cold spots, or no radiator at all? We visit, calculate BTU heat output needed for each room, and recommend the right radiator type and size." },
      { step: 2, title: "Choose your radiators", desc: "Horizontal, vertical, or designer radiators — we show options, discuss aesthetics and performance, and quote a fixed price including labour." },
      { step: 3, title: "We drain the system", desc: "We safely isolate and drain the heating system, then carefully remove the old radiators (disposal included)." },
      { step: 4, title: "Install and pipework", desc: "We fit new radiators, reconnect or reroute pipework as needed, fit TRVs where required, and pressure-test all new connections." },
      { step: 5, title: "Refill and balance", desc: "We refill the system, check all pressures and temperatures, and balance the system so every radiator heats evenly." },
      { step: 6, title: "Test and handover", desc: "We test all radiators, valves and controls, then show you how to use TRVs and maintain your system. 12-month guarantee on all work." },
    ],
    googleReviewsUrl: "https://www.google.com/maps/place/Just+Imagine+Ltd+Heating+%26+Plumbing/@52.3704,-1.2658,15z/data=!4m5!3m4!1s0x0:0x0!8m2!3d52.3704!4d-1.2658",
  },
  {

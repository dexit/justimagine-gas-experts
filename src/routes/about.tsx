...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Family-run, Gas Safe registered heating and plumbing specialists serving local homeowners, landlords and businesses." },
    ],
  }),
  component: AboutPage,
});
...
function AboutPage() {
  return (
    <PageShell>
      <PageHero eyebrow="About" title="A small team. A serious craft." subtitle="Just Imagine Ltd was built on one simple idea — do every job like it's in your own home." />

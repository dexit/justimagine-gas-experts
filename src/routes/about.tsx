      ...
      <section className="mx-auto max-w-7xl px-5 lg:px-8 py-20 grid lg:grid-cols-5 gap-12">
        <div className="lg:col-span-3 space-y-5 text-muted-foreground leading-relaxed">
          <p className="text-lg text-foreground">
            We're a Gas Safe registered heating and plumbing company serving homeowners, landlords
            and small businesses across the region.
          </p>
          <p>
            Our work covers everything from emergency boiler repairs at 2am to full system upgrades,
            landlord safety certificates, plumbing remedials and ad-hoc manual work for property
            managers.
          </p>
          <p>
            What sets us apart isn't fancy marketing — it's the basics, done properly. We turn up
            when we say we will. We tidy up after ourselves. We charge fair prices and we explain
            exactly what we've done and why.
          </p>
          ...
          {[
            {
              ...
              d: "Every engineer on the official register.",
            },
            { icon: Award, t: "Manufacturer Trained", d: "Worcester, Vaillant, Ideal & more." },
            {
              icon: Users,
              t: "Local & Independent",
              d: "We live and work in the community we serve.",
            },
            {
              icon: Heart,
              t: "Customer First",
              d: "Most of our work comes through repeat clients.",
            },
          ].map((c) => (

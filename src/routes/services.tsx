...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Boiler installation & servicing, gas safety certificates, heating, plumbing, repairs and 24/7 emergency callouts." },
    ],
  }),
...
function ServicesPage() {
  return (
    <PageShell>
      <PageHero eyebrow="Services" title="Everything heating, gas & plumbing — under one roof." subtitle="From a quick washer change to a full boiler swap, we handle the lot. Properly certified, properly insured, properly finished." />
